           ...
           <h3 className={styles.rulesTitle}>BLACKJACK EARLY PAYOUT</h3>
            <Collapsible title={"Bajo: USD. 1.00 - USD. 20.00. "}>
                <p>
                    ...
                    juego lleno de particularidades especiales diseñadas para ofrecer una experiencia excepcional en el juego de 
                    Blackjack con Dealers en vivo.
                </p>
                <p>
                    <span>
                ...
                <p>El dealer pide cartas con un 17 suave.</p>
                <p>
                ...
                <p>El seguro paga 2:1.</p>
                <p><span>Apuestas secundarias:</span></p>
                <p>
                ...
                <p>3 cartas del mismo valor (por ejemplo 10H, 10D, 10S)</p>
                <p>3 cartas del mismo palo (por ejemplo 2D, 9D, KD)</p>
                <p>
